...
public interface OrientacionVocacionalRepository extends JpaRepository<OrientacionVocacional, Long> {
    ...
    List<OrientacionVocacional> findByFechaBetween(LocalDate desde, LocalDate hasta);

    List<OrientacionVocacional> findByFechaBetweenAndPacienteExternoPsicologoId(LocalDate desde, LocalDate hasta, Long psicologoId);
}